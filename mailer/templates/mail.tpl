...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	*/
		h1{
			/*@editable*/color:#00A859 !important;
			display:block;
	...
	*/
		h2{
			/*@editable*/color:#151515 !important;
			display:block;
			/*@editable*/font-family:Helvetica;
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                                                            <img align="left" alt="" src="http://placehold.it/320x120" style="max-width:800px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="mcnTextBlockInner">
                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                <tbody>
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;color: #151515;">
                                                                            <h1><span style="color:ED1B23">{{ trans.title }}</span></h1>
                                                                            &nbsp;
                                                                            <h3>{{ trans.salution }} {{ order.shippingAddress.name }},</h3>
                                                                            <p>
                                                                                {{ text }}
                                                                                <br>
                                                                                <br>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;color: #151515;">
                                                                            ...
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                                ...
                                                                                <tr>
                                                                                    <td><strong>{{ trans.postalcode }}:</strong></td>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;color: #151515;">
                                                                            ...
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                                ...
                                                                                <tr>
                                                                                    <td><strong>{{ trans.orderdate }}:</strong></td>
                                                                                    <td>{{ order.time.sec | date('d-m-Y H:i') }}</td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;color: #151515;">
                                                                            ...
                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                                ...
                                                                                <tr>
                                                                                    <td rowspan="4" style="width: 80px;"><img align="left" alt="" src="http://placehold.it/77x77" style="max-width:800px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage"></td>
                                                                                    <td align="right">
                                                                                        {{ trans.sku }}:
                                                                                    </td>
                                                                                    <td align="right">
